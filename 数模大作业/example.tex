...
\begin{table}[htbp]
	...
	\begin{tabular}{cccccc}
		\toprule  % 顶线
		stock\_code & stock\_abbr & net\_profit(万元) ··· & repor\_period & report\_year \\
		\midrule  % 中线
		600080      & 金花股份        & 3345.950516                  & FY            & 2022         \\
		600080      & 金花股份        & 468.093536                   & Q1            & 2023         \\
		600080      & 金花股份        & 339.02983                    & Q3            & 2023         \\
...
当用户发起“依据是什么”类追问时，系统调用解释函数，从归因链路中抽取与质疑点最相关的局部子图，返回对应的报表字段、研报摘录及推理路径。设质疑问题为$$Q^\dagger$$，则解释函数定义为
\begin{equation}
