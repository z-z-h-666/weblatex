...
\keywords{高度--速度联合优化；燃油消耗模型；最优控制；垂直风切变；路径积分}
\end{abstract}
...
\begin{figure}[H]
	\centering
	\IfFileExists{2.eps}{\includegraphics[width=1.1\textwidth]{2.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{3.eps}{\includegraphics[width=1\textwidth]{3.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{4.eps}{\includegraphics[width=0.7\textwidth]{4.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{5.eps}{\includegraphics[width=1\textwidth]{5.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{6.eps}{\includegraphics[width=0.9\textwidth]{6.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{7.eps}{\includegraphics[width=0.6\textwidth]{7.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{8.eps}{\includegraphics[width=0.6\textwidth]{8.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{9.eps}{\includegraphics[width=0.6\textwidth]{9.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{10.eps}{\includegraphics[width=0.6\textwidth]{10.eps}}{\fbox{Missing figure}}
...
\begin{figure}[H]
	\centering
	\IfFileExists{11.eps}{\includegraphics[width=1\textwidth]{11.eps}}{\fbox{Missing figure}}
	\caption{模型扩展参数沿航程变化}
	\label{fig:6}
\end{figure}
...
\begin{figure}[H]
	\centering
	\IfFileExists{12.eps}{\includegraphics[width=0.7\textwidth]{12.eps}}{\fbox{Missing figure}}
	\caption{模型扩展参数沿航程变化}
	\label{fig:7}
\end{figure}
